      ...
      <nav className="flex-1 w-full flex flex-col items-center space-y-6">
        {menuItems.map((item) => (
          ...
          >
            ...
            <div className="absolute left-full ml-2 px-2 py-1 rounded bg-card/80 backdrop-blur-sm text-xs whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
              {item.label}
            </div>
          </motion.button>
        ))}
